          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-3">
                  <label for="name" class="form-label">Nama Pemilik / Admin</label>
                  <input
                    type="text"
                    class="form-control @error('name') is-invalid @enderror"
                    id="name"
                    name="name"
                    placeholder="Masukkan nama pemilik atau admin"
                    value="{{ old('name') }}"
                  />
                  @error('name')
                    <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="mb-3">
                  <label for="no_whatsapp" class="form-label">Nomor WhatsApp (WAJIB)</label>
                  <input
                    type="text"
                ...
                <div class="mb-3">
                  <label for="alamat_bengkel" class="form-label">Alamat Bengkel (Jalan + Kota)</label>
                  <textarea
                    class="form-control @error('alamat_bengkel') is-invalid @enderror"
                    id="alamat_bengkel"
                    name="alamat_bengkel"
                    placeholder="Masukkan alamat lengkap bengkel"
                    rows="3"
                  >{{ old('alamat_bengkel') }}</textarea>
